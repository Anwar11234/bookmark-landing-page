...
module.exports["default"] = module.exports, module.exports.__esModule = true;
},{"@babel/runtime-corejs2/core-js/array/is-array":"../node_modules/@babel/runtime-corejs2/core-js/array/is-array.js","./arrayLikeToArray.js":"../node_modules/@babel/runtime-corejs2/helpers/arrayLikeToArray.js"}],"../node_modules/core-js/library/modules/_redefine.js":[function(require,module,exports) {
...
},{"core-js/library/fn/symbol/iterator":"../node_modules/core-js/library/fn/symbol/iterator.js"}],"../node_modules/core-js/library/modules/_iter-call.js":[function(require,module,exports) {
...
},{"core-js/library/fn/array/from":"../node_modules/core-js/library/fn/array/from.js"}],"../node_modules/@babel/runtime-corejs2/helpers/iterableToArray.js":[function(require,module,exports) {
...
module.exports["default"] = module.exports, module.exports.__esModule = true;
},{"@babel/runtime-corejs2/core-js/object/define-property":"../node_modules/@babel/runtime-corejs2/core-js/object/define-property.js"}],"components/menu.js":[function(require,module,exports) {
"use strict";
...
var Menu = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Menu, [{
    ...
    value: function toggle() {
      ...
      this.menuContainer.addEventListener('keydown', function (event) {
    ...
    value: function handleKeyDown(event) {
      var focusableChildren = (0, _toConsumableArray2.default)(this.menuContainer.querySelectorAll('[data-focusable]'));
      var firstChild = focusableChildren[0];
      var lastChild = focusableChildren[focusableChildren.length - 1];
...
},{"@babel/runtime-corejs2/helpers/toConsumableArray":"../node_modules/@babel/runtime-corejs2/helpers/toConsumableArray.js","@babel/runtime-corejs2/helpers/classCallCheck":"../node_modules/@babel/runtime-corejs2/helpers/classCallCheck.js","@babel/runtime-corejs2/helpers/createClass":"../node_modules/@babel/runtime-corejs2/helpers/createClass.js"}],"components/tabs.js":[function(require,module,exports) {
"use strict";
...
var Tabs = /*#__PURE__*/function () {
  function Tabs(container) {
    ...
    this.tabs = (0, _toConsumableArray2.default)(this.container.querySelectorAll('[role="tab"]'));
  }

  (0, _createClass2.default)(Tabs, [{
    key: "switchTab",
    value: function switchTab(event) {
      var oldTab = this.container.querySelector('[aria-selected]');
      var newTab = event.currentTarget;
      if (oldTab === newTab) return;
      var oldPanel = this.container.querySelector("[aria-labelledby = ".concat(oldTab.id, "]"));
      var newPanel = this.container.querySelector("[aria-labelledby = ".concat(newTab.id, "]"));
      this.hidePanel(oldTab, oldPanel);
      this.showPanel(newTab, newPanel);
    }
  }, {
    key: "hidePanel",
    value: function hidePanel(tab, panel) {
      panel.hidden = true;
    ...
    key: "showPanel",
    value: function showPanel(tab, panel) {
      panel.hidden = false;
    ...
    value: function moveRight(event) {
      ...
      var nextTab = this.tabs[++currentIndex];
    ...
    value: function moveLeft(event) {
      var currentIndex = this.tabs.indexOf(event.currentTarget);
      var prevTab = this.tabs[--currentIndex];
    ...
    key: "manageFocus",
    value: function manageFocus(event) {
      var codes = ['ArrowRight', 'ArrowLeft', 'Home', 'End'];
...
},{"@babel/runtime-corejs2/helpers/toConsumableArray":"../node_modules/@babel/runtime-corejs2/helpers/toConsumableArray.js","@babel/runtime-corejs2/helpers/classCallCheck":"../node_modules/@babel/runtime-corejs2/helpers/classCallCheck.js","@babel/runtime-corejs2/helpers/createClass":"../node_modules/@babel/runtime-corejs2/helpers/createClass.js"}],"components/accordion.js":[function(require,module,exports) {
"use strict";
...
var Accordion = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Accordion, [{
    key: "togglePanel",
    value: function togglePanel(event) {
      var btn = event.currentTarget;
      var target = document.querySelector("[aria-labelledby=".concat(btn.id, "]"));
    ...
    value: function handleArrowDown(event) {
      var currentBtnIndex = this.btns.indexOf(event.currentTarget);
      var nextAccordionHeader = this.btns[++currentBtnIndex];
    ...
    value: function handleArrowUp(event) {
      var currentBtnIndex = this.btns.indexOf(event.currentTarget);
      var prevAccordionHeader = this.btns[--currentBtnIndex];
...
var menu = new _menu.default(header);
menuBtn.addEventListener('click', function () {
  menu.toggle();
});
var tabsContainer = document.querySelector('.tabs');
var tabList = (0, _toConsumableArray2.default)(tabsContainer.querySelectorAll('[role="tab"]'));
var tabs = new _tabs.default(tabsContainer);
...
var accordionContainer = document.querySelector('.faqs');
var accordionBtns = (0, _toConsumableArray2.default)(accordionContainer.querySelectorAll('h2 button'));
var accordion = new _accordion.default(accordionBtns);
...
},{"@babel/runtime-corejs2/helpers/toConsumableArray":"../node_modules/@babel/runtime-corejs2/helpers/toConsumableArray.js","./components/menu":"components/menu.js","./components/tabs":"components/tabs.js","./components/accordion":"components/accordion.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
